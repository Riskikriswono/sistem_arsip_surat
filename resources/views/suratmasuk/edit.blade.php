...
<div class="d-sm-flex align-items-center justify-content-between mb-2">
    <h4 class="mb-0 text-gray-800">Arsip Surat Masuk</h4>
    @if(session('status'))
    ...
    <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="mb-2 row">
            <div class="col-md-6">
                ...
                <input type="text" id="pengirim" name="pengirim" value="{{$data->pengirim}}"
        ...
        <div>
            <a href="{{url('/suratmasuk/update/'.$data->id_sm)}}"> <button type="submit"
            ...
            <a href="{{ asset('filesuratmasuk/'.$data->dokumen) }}" target="_blank"><button type="button"
