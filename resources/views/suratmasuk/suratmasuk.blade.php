...
<div class="row align-items-center mb-2">
    <div class="col-4">
        <h4 class=" mb-0 text-gray-800">Surat Masuk</h4>
    </div>
...
<div class="row">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{url('/suratmasuk/tambahsuratm')}}"><button type="button" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{url('/suratmasuk/edit/'.$item->id_sm)}}"><i
                                        class="fa-solid fa-pen-to-square fa-lg" style="color:blue"></i></a>
                                |
                                <a href="{{url('/suratmasuk/hapus/'.$item->id_sm)}}"
